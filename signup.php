...
if(isset($_POST['reg_user']))
{
	...
	if(!empty($_POST['user_id']))
    {
		...
		{ 
			...
			$query1 = "INSERT INTO RegisteredUser(user_id,firstname,lastname,middlename,addressline1,addressline2,city,state,zip_code,phone_number1,phone_number2,email_id) VALUES('$user_id','$firstname','$lastname','$middlename','$al1','$al2','$city','$state','$zip_code','$phone1','$phone2','$email')";
